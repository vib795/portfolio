...
import { formatPostDate, getSitePost, getSitePostSlugs } from "@/lib/blog";
import { profile, socials } from "@/lib/content";

// Every on-site post is known at build time, so anything else is a real 404.
export const dynamicParams = false;

export function generateStaticParams() {
  return getSitePostSlugs().map((slug) => ({ slug }));
}
