...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "iOS App",
    blurb:
      "A native iOS app for capturing voice memos, notes, journals, meeting recordings, photos, and saved URLs — then chatting with them. Transcription, embeddings, and RAG search all run on-device via Apple Speech and NLEmbedding; only the final answer is generated by Claude through the user's own API key, with no backend or account.",
    stack: ["SwiftUI", "Apple Speech", "NLEmbedding", "Anthropic"],
    link: "https://github.com/vib795/second-brain",
  },
  {
    ...
    link: "https://github.com/vib795/passport-tool-ios",
  },
];
